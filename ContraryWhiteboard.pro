...
win32 {
   ...
   THIRD_PARTY_PATH=thirdpartydeps
   ...
   RC_FILE = resources/win/ContraryWhiteboard.rc
   CONFIG += axcontainer
...
# Note: QRC file kept as OpenBoard.qrc to avoid renaming hundreds of resource references
